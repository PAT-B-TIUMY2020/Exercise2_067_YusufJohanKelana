...
namespace Exercise2_067_Yusuf_Johan_Kelana {
    ...
    public partial class TI_UMYDataSet : global::System.Data.DataSet {
        ...
        public partial class MahasiswaDataTable : global::System.Data.TypedTableBase<MahasiswaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public MahasiswaRow AddMahasiswaRow(string NIM, string Nama, string Prodi, string Angkatan) {
...
namespace Exercise2_067_Yusuf_Johan_Kelana.TI_UMYDataSetTableAdapters {
    ...
    public partial class MahasiswaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Mahasiswa] WHERE (([NIM] = @Original_NIM) AND ((@IsNull_Nama = 1 AND [Nama] IS NULL) OR ([Nama] = @Original_Nama)) AND ((@IsNull_Prodi = 1 AND [Prodi] IS NULL) OR ([Prodi] = @Original_Prodi)) AND ((@IsNull_Angkatan = 1 AND [Angkatan] IS NULL) OR ([Angkatan] = @Original_Angkatan)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Mahasiswa] ([NIM], [Nama], [Prodi], [Angkatan]) VALUES (@NIM, " +
                "@Nama, @Prodi, @Angkatan);\r\nSELECT NIM, Nama, Prodi, Angkatan FROM Mahasiswa WHE" +
                "RE (NIM = @NIM)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Mahasiswa] SET [NIM] = @NIM, [Nama] = @Nama, [Prodi] = @Prodi, [Angkatan] = @Angkatan WHERE (([NIM] = @Original_NIM) AND ((@IsNull_Nama = 1 AND [Nama] IS NULL) OR ([Nama] = @Original_Nama)) AND ((@IsNull_Prodi = 1 AND [Prodi] IS NULL) OR ([Prodi] = @Original_Prodi)) AND ((@IsNull_Angkatan = 1 AND [Angkatan] IS NULL) OR ([Angkatan] = @Original_Angkatan)));
SELECT NIM, Nama, Prodi, Angkatan FROM Mahasiswa WHERE (NIM = @NIM)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Exercise2_067_Yusuf_Johan_Kelana.Properties.Settings.Default.TI_UMYConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT NIM, Nama, Prodi, Angkatan FROM dbo.Mahasiswa";
        ...
        public virtual int Delete(string Original_NIM, string Original_Nama, string Original_Prodi, string Original_Angkatan) {
        ...
        public virtual int Insert(string NIM, string Nama, string Prodi, string Angkatan) {
            if ((NIM == null)) {
        ...
        public virtual int Update(string NIM, string Nama, string Prodi, string Angkatan, string Original_NIM, string Original_Nama, string Original_Prodi, string Original_Angkatan) {
            if ((NIM == null)) {
                throw new global::System.ArgumentNullException("NIM");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nama, string Prodi, string Angkatan, string Original_NIM, string Original_Nama, string Original_Prodi, string Original_Angkatan) {
            return this.Update(Original_NIM, Nama, Prodi, Angkatan, Original_NIM, Original_Nama, Original_Prodi, Original_Angkatan);
        }
    }
